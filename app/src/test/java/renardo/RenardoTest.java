...
public class RenardoTest {
        ...
        void calculationResultsOnTwoNumbers() {
                ...
                suite.calculate();
                assertArrayEquals(new int[] { 11, 9, 10, 10 }, suite.getCalculation().getValues());
                value = new int[] { 10, 25 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 35, 15, 250 }, suite.getCalculation().getValues());
                value = new int[] { 5, 100 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 105, 95, 500, 20 }, suite.getCalculation().getValues());
                value = new int[] { 100, 25 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 125, 75, 2500, 4 }, suite.getCalculation().getValues());
                value = new int[] { 25, 5 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 30, 20, 125, 5 }, suite.getCalculation().getValues());
        }
        ...
        void calculationOperationsOnTwoNumbers() {
                ...
                assertArrayEquals(new String[] { "11 = 10 + 1", "9 = 10 - 1", "10 = 10 x 1", "10 = 10 : 1" },
                                suite.getCalculation().getOperations());
                value = new int[] { 10, 25 };
                suite = new Suite(value);
                suite.calculate();
        ...
        void calculationValidResultsOnTwoNumbers() {
                ...
                Suite suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] {}, suite.getValues());
                value = new int[] { 10, 25 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 250 }, suite.getValues());
                value = new int[] { 5, 100 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 105, 500 }, suite.getValues());
                value = new int[] { 100, 25 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 125 }, suite.getValues());
                value = new int[] { 25, 5 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 125 }, suite.getValues());
        ...
        @Test
        void singleRoundCalculationResultsOnThreeNumbers() {
                ...
                assertArrayEquals(
                                new int[] { 105, 95, 500, 20, 130, 80, 2625, 120, 70, 2375, 525, 475, 12500, 20, 45, 5,
                                                500 },
                                suite.getCalculation().getValues());
                value = new int[] { 100, 25, 5 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(
                                new int[] { 125, 75, 2500, 4, 130, 120, 625, 25, 80, 70, 375, 15, 2505, 2495, 12500,
                                                500, 9, 1, 20 },
                                suite.getCalculation().getValues());
                value = new int[] { 25, 5, 100 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(
                                new int[] { 30, 20, 125, 5, 130, 70, 3000, 120, 80, 2000, 5, 225, 25, 12500, 105, 95,
                                                500, 20 },
                                suite.getCalculation().getValues());
        }

        @Test
        void singleRoundCalculationOperationsOnThreeNumbers() {
                int[] value = new int[] { 5, 100, 25 };
                Suite suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(
                                new String[] { "105 = 5 + 100", "95 = 100 - 5", "500 = 5 x 100", "20 = 100 : 5",
                                                ...
                                                "500 = 20 x 25,20 = 100 : 5" },
                                suite.getCalculation().getOperations());
                value = new int[] { 100, 25, 5 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(
                                new String[] { "125 = 100 + 25", "75 = 100 - 25", "2500 = 100 x 25", "4 = 100 : 25",
                ...
                suite.calculate();
                assertArrayEquals(
                                new String[] { "30 = 25 + 5", "20 = 25 - 5", "125 = 25 x 5", "5 = 25 : 5",
        ...
        @Test
        void singleRoundCalculationValidResultsOnThreeNumbers() {
                int[] value = new int[] { 5, 100, 25 };
                Suite suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 105, 500, 130, 120, 525, 475, 500 }, suite.getValues());
                value = new int[] { 100, 25, 5 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 125, 130, 120, 625, 375, 500 }, suite.getValues());
                value = new int[] { 25, 5, 100 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(new int[] { 125, 130, 120, 225, 105, 500 }, suite.getValues());
        }
        ...
        void singleRoundCalculationValidOperationsOnThreeNumbers() {
                ...
                suite.calculate();
                assertArrayEquals(
                                new String[] { "125 = 100 + 25", "130 = 125 + 5,125 = 100 + 25",
                                                "120 = 125 - 5,125 = 100 + 25",
                                                "625 = 125 x 5,125 = 100 + 25", "375 = 75 x 5,75 = 100 - 25",
                                                "500 = 2500 : 5,2500 = 100 x 25" },
                                suite.getOperations());
                value = new int[] { 25, 5, 100 };
                suite = new Suite(value);
                suite.calculate();
                assertArrayEquals(
                                new String[] { "125 = 25 x 5", "130 = 30 + 100,30 = 25 + 5",
                                                "120 = 20 + 100,20 = 25 - 5",
